...
";
        ...
        {
            return MySqlTools.LoadPrimaryKey(this.Connection, this.Schema, this.TableName);
...
";
            ...
            var referencedTablePk = MySqlTools.LoadPrimaryKey(this.Connection, this.Schema, referencedTableName);
