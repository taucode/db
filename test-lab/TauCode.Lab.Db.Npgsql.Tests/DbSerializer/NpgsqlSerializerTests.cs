...
namespace TauCode.Lab.Db.Npgsql.Tests.DbSerializer
{
    [TestFixture]
    public class NpgsqlSerializerTests : TestBase
    {
        ...
        public void Constructor_ValidArguments_RunsOk(string schemaName)
        {
            ...
            // Act
            IDbSerializer serializer = new NpgsqlSerializerLab(this.Connection, schemaName);

            // Assert
            Assert.That(serializer.Connection, Is.SameAs(this.Connection));
            Assert.That(serializer.Factory, Is.SameAs(NpgsqlUtilityFactoryLab.Instance));
            Assert.That(serializer.SchemaName, Is.EqualTo("public"));
            Assert.That(serializer.Cruder, Is.TypeOf<NpgsqlCruderLab>());
        }
        ...
        public void Constructor_ConnectionIsNull_ThrowsArgumentNullException()
        {
            ...
            // Act
            var ex = Assert.Throws<ArgumentNullException>(() => new NpgsqlSerializerLab(null, "public"));
        ...
        public void Constructor_ConnectionIsNotOpen_ThrowsArgumentException()
        {
            ...
            // Act
            var ex = Assert.Throws<ArgumentException>(() => new NpgsqlSerializerLab(connection, "public"));
        ...
        {
            // Arrange
            IDbSerializer serializer = new NpgsqlSerializerLab(this.Connection, "zeta");
        ...
        {
            // Arrange
            IDbSerializer serializer = new NpgsqlSerializerLab(this.Connection, "bad_schema");
        ...
        {
            // Arrange
            IDbInspector dbInspector = new NpgsqlInspectorLab(this.Connection, "zeta");
            ...
            var dateTime = (DateTime)harveyPhoto1["TakenAt"];
            DateTimeOffset dateTimeOffset = dateTime;
            Assert.That(dateTimeOffset, Is.EqualTo(DateTimeOffset.Parse("1997-12-12T11:12:13+00:00")));
            ...
            dateTime = (DateTime)harveyPhoto2["TakenAt"];
            dateTimeOffset = dateTime;
            Assert.That(dateTimeOffset, Is.EqualTo(DateTimeOffset.Parse("1991-01-01T02:16:17+00:00")));
            ...
            dateTime = (DateTime)mariaPhoto1["TakenAt"];
            dateTimeOffset = dateTime;
            Assert.That(dateTimeOffset, Is.EqualTo(DateTimeOffset.Parse("1998-04-05T08:09:22+00:00")));
            ...
            dateTime = (DateTime)mariaPhoto2["TakenAt"];
            dateTimeOffset = dateTime;
            Assert.That(dateTimeOffset, Is.EqualTo(DateTimeOffset.Parse("2001-06-01T11:12:19+00:00")));
