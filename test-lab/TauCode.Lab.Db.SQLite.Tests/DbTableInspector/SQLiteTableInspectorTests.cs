...
namespace TauCode.Lab.Db.SQLite.Tests.DbTableInspector
{
    [TestFixture]
    public class SQLiteTableInspectorTests : TestBase
    {
        ...
        public void Constructor_ValidArguments_RunsOk()
        {
            ...
            // Act
            IDbTableInspector inspector = new SQLiteTableInspectorLab(this.Connection, "dbo", "tab1");
        ...
        public void Constructor_ConnectionIsNull_ThrowsArgumentNullException()
        {
            ...
            // Act
            var ex = Assert.Throws<ArgumentNullException>(() => new SQLiteTableInspectorLab(null, "dbo", "tab1"));
        ...
        public void Constructor_SchemaIsNull_RunsOkAndSchemaIsDbo()
        {
            ...
            // Act
            IDbTableInspector inspector = new SQLiteTableInspectorLab(this.Connection, null, "tab1");
        ...
        public void Constructor_TableNameIsNull_ThrowsArgumentNullException()
        {
            ...
            // Act
            var ex = Assert.Throws<ArgumentNullException>(() => new SQLiteTableInspectorLab(this.Connection, "dbo", null));
        ...
        public void GetColumns_ValidInput_ReturnsColumns()
        {
            ...
            var dictionary = tableNames
                .Select(x => new SQLiteTableInspectorLab(this.Connection, "zeta", x))
        ...
        {
            // Arrange
            IDbTableInspector inspector = new SQLiteTableInspectorLab(this.Connection, "bad_schema", "tab1");
        ...
        {
            // Arrange
            IDbTableInspector inspector = new SQLiteTableInspectorLab(this.Connection, "zeta", "bad_table");
        ...
        {
            // Arrange
            var tableNames = this.Connection.GetTableNames(null);
        ...
        {
            // Arrange
            IDbTableInspector inspector = new SQLiteTableInspectorLab(this.Connection, "zeta", "PersonData");
        ...
        {
            // Arrange
            IDbTableInspector inspector1 = new SQLiteTableInspectorLab(this.Connection, "zeta", "Person");
            IDbTableInspector inspector2 = new SQLiteTableInspectorLab(this.Connection, "zeta", "WorkInfo");
            IDbTableInspector inspector3 = new SQLiteTableInspectorLab(this.Connection, "zeta", "HealthInfo");
        ...
        {
            // Arrange
            IDbTableInspector inspector = new SQLiteTableInspectorLab(this.Connection, "zeta", "HealthInfo");
