...
namespace TauCode.Lab.Db.MySql.Tests.DbSerializer
{
    ...
    public class MySqlSerializerTests : TestBase
    {
        ...
        public void Constructor_ValidArguments_RunsOk()
        {
            ...
            Assert.That(serializer.Factory, Is.SameAs(MySqlUtilityFactory.Instance));
            Assert.That(serializer.SchemaName, Is.EqualTo("zeta"));
            Assert.That(serializer.Cruder, Is.TypeOf<MySqlCruder>());
        }
        ...
        public void Constructor_ConnectionIsNull_ThrowsArgumentNullException()
        {
            ...
            // Act
            var ex = Assert.Throws<ArgumentNullException>(() => new MySqlSerializer(null));
        ...
        public void Constructor_ConnectionIsNotOpen_ThrowsArgumentException()
        {
            ...
            // Act
            var ex = Assert.Throws<ArgumentException>(() => new MySqlSerializer(connection));
        ...
        public void DeserializeDbData_ValidArguments_RunsOk()
        {
            ...
            IDbInspector dbInspector = new MySqlInspector(this.Connection);
